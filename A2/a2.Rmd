...
knitr::kable(ols_summary, caption = "TITLE", digits = 2 ) %>% kable_styling( position = "center", latex_options = 'hold_position' )
```
...
knitr::kable(summary(data_extra$future_price), caption = "TITLE", digits = 2 ) %>% kable_styling( position = "center", latex_options = 'hold_position' )
